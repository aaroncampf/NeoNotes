...
#Region "My Privates"
		...
		'Private m_textColor As RtfColors

		' The default text background color
		'Private highlightColor As RtfColors
...
#Region "Accessors"
        ...
        ''' <value></value>
        ''' <remarks></remarks>
        Public Property TextColor As RtfColors
        ...
        ''' <value></value>
        ''' <remarks></remarks>
        Public Property HighlightColor As RtfColors
...
#Region "Constructors"
		...
		Public Sub New()
            ...
            TextColor = RtfColors.Black
			HighlightColor = RtfColors.White
            ' Initialize the dictionary mapping color codes to definitions
            rtfColor = New HybridDictionary(16) '<-- Aaron Added the 16 [Sets Initial Size, 16 is the Number of Items being Added to the Collection]
            rtfColor.Add(RtfColors.Aqua, RtfColorDef.Aqua)
			rtfColor.Add(RtfColors.Black, RtfColorDef.Black)
			rtfColor.Add(RtfColors.Blue, RtfColorDef.Blue)
			rtfColor.Add(RtfColors.Fuchsia, RtfColorDef.Fuchsia)
			rtfColor.Add(RtfColors.Gray, RtfColorDef.Gray)
			rtfColor.Add(RtfColors.Green, RtfColorDef.Green)
			rtfColor.Add(RtfColors.Lime, RtfColorDef.Lime)
			rtfColor.Add(RtfColors.Maroon, RtfColorDef.Maroon)
			rtfColor.Add(RtfColors.Navy, RtfColorDef.Navy)
			rtfColor.Add(RtfColors.Olive, RtfColorDef.Olive)
			rtfColor.Add(RtfColors.Purple, RtfColorDef.Purple)
			rtfColor.Add(RtfColors.Red, RtfColorDef.Red)
			rtfColor.Add(RtfColors.Silver, RtfColorDef.Silver)
			rtfColor.Add(RtfColors.Teal, RtfColorDef.Teal)
			rtfColor.Add(RtfColors.White, RtfColorDef.White)
			rtfColor.Add(RtfColors.Yellow, RtfColorDef.Yellow)
        ...
        Public Sub New(ByVal _textColor As RtfColors)
			Me.New()
        ...
        Public Sub New(ByVal _textColor As RtfColors, ByVal _highlightColor As RtfColors)
			Me.New()
			TextColor = _textColor
...
#Region "Append RTF or Text to RichTextBox Contents"
        ...
        ''' <param name="_font"></param>
        ''' <param name="_textColor"></param>
        Public Sub AppendTextAsRtf(ByVal _text As String, ByVal _font As Font, ByVal _textColor As RtfColors)
        ...
        Public Sub AppendTextAsRtf(ByVal _text As String, ByVal _font As Font, ByVal _textColor As RtfColors, ByVal _backColor As RtfColors)
...
#Region "Insert Plain Text"
        ...
        ''' <param name="_font"></param>
        ''' <param name="_textColor"></param>
        Public Sub InsertTextAsRtf(ByVal _text As String, ByVal _font As Font, ByVal _textColor As RtfColors)
        ...
        ''' <param name="_textColor"></param>
        ''' <param name="_backColor"></param>
        Public Sub InsertTextAsRtf(ByVal _text As String, ByVal _font As Font, ByVal _textColor As RtfColors, ByVal _backColor As RtfColors)
...
#Region "RTF Helpers"
        ...
        ''' <param name="_backColor"></param>
        ''' <returns></returns>
        Private Function GetColorTable(ByVal _textColor As RtfColors, ByVal _backColor As RtfColors) As String
